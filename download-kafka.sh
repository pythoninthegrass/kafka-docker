...
Test to see if the suggested mirror has this version, currently pre 2.1.1 versions do not appear to be actively mirrored. This may also
be useful if closer.cgi is down.
DESCRIPTION
